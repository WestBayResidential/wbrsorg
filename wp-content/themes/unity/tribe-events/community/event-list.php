...
$icons = array(
	...
	<div id="add-new"><a href="<?php echo esc_url( tribe_community_events_add_event_link() ); ?>" class="vamtam-button button button-border accent-2 hover-accent-2"><span class="btext"><?php echo apply_filters( 'tribe_ce_add_event_button_text', __( 'Add New','tribe-events-community' ) ); ?></span></a></div>
				...
				while ( $events->have_posts() ) {
					...
					<tr>
						...
						<div class="row-actions">
							<span class="view">
								<a href="<?php echo esc_url( tribe_get_event_link( $post ) ); ?>"><?php _e( 'View','tribe-events-community' ); ?></a>
							</span>
							<?php if ( $canEdit ) {
