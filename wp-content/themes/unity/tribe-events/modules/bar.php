...
<div id="tribe-events-bar">
	...
	<form id="tribe-bar-form" class="tribe-clearfix" name="tribe-bar-form" method="post" action="<?php echo esc_url( $current_url ); ?>">
		...
		<div class="first-column col-lg-9 col-sm-8 col-xs-12">
			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					...
					<div class="tribe-bar-submit">
						<button class="tribe-no-param btn btn-donate-black" type="submit" name="submit-bar"><span class="icon"><i class="fa fa-setting"></i></span><span class="btext"><?php _e( 'Find Events', 'tribe-events-calendar' ) ?></span></button>
		...
		<div class="second-column col-lg-3 col-sm-4 col-xs-12">
