...
<div class="author-description">
	...
	<div class="author-info">	
		...
		<div class="author-stats">
			...
			<p>	<?php printf( _n( '%d campaign', '%d campaigns', $campaigns->post_count, TEXTDOMAIN ), $campaigns->post_count ) ?>
			</p>
		</div>
	</div>	
	...
	<div class="desc">	
		...
		<p class="author-profile-link center">
			<a href="<?php echo esc_url( get_author_posts_url($author->ID) ); ?>" class="button button-alt"><?php _e( 'Profile', TEXTDOMAIN ) ?></a>
		</p>
	</div>	
