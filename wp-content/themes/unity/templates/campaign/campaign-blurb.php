	...
	<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<?php if ( $campaign->is_funded() ) : ?>
					<span class="campaign-successful"><?php _e( 'Successful', TEXTDOMAIN ) ?></span>
				<?php elseif ( ! $campaign->is_active() && ! $campaign->is_funded() ) : ?>
					<span class="campaign-unsuccessful"><?php _e( 'Unsuccessful', TEXTDOMAIN ) ?></span>
				<?php endif ?>
				</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 xs-text-center">
				...
				<div class="quick-donate">
					<a class="btn btn-donate-black" data-toggle="modal" data-target="#campaign-quick-donate-<?php echo esc_attr(get_the_ID() . "-$uid") ?>"><?php _e('Donate now', TEXTDOMAIN); ?></a>
				</div>
		      	...
		      	<div class="modal-body">
		      		<div class="campaign-content">
						<div class="barometer" data-progress="<?php echo esc_attr( $campaign->percent_completed(false) ); ?>" data-width="148" data-height="148" data-strokewidth="11" data-stroke="#DEDEDE" data-progress-stroke="#F6B21F">
							<span><?php printf( _x( "%s", 'x percent funded',TEXTDOMAIN ), '<span class="funded">'.esc_html( $campaign->percent_completed(false) ).'<sup>%</sup></span>' ) ?></span>
						</div>	
					...
					<div class="desciption">
						<?php echo wpo_excerpt(36, '... <a class="read-more" href="' . esc_url( get_the_permalink() ). '">' . __('Read more', TEXTDOMAIN) . '</a>'); ?>					
					</div>
