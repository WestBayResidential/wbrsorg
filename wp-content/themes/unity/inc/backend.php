		...
		public function makeCustomMetaBoxs(){
			$path = WPO_THEME_SUB_DIR   . 'customfield/';
		 	...
		 	new WPO_MetaBox(array(
				'id'       => 'wpo_postconfig',
				'title'    => $this->l('Post Configuration'),
				'types'    => array('post'),
				'priority' => 'high',
			...
			//Post setting
		 	new WPO_MetaBox(array(
				'id'       => 'wpo_brandconfig',
				'title'    => $this->l('Brands Configuration'),
				'types'    => array('brands'),
				'priority' => 'high',
			...
			$aa = new WPO_MetaBox(array(
				'id'       => 'wpo_pageconfig',
				'title'    => $this->l('Gallery Configuration'),
				'types'    => array('gallery'),
				'priority' => 'high',
			...
			new WPO_MetaBox(array(
				'id'       => 'wpo_portfolio',
				'title'    => $this->l('Portfolio Options'),
