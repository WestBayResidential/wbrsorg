...
!important: All theme profiles are stored in folder YOURTHEME/css/customze, it need permission 0755 to put files inside').'
            </div>' .'<div><a href="'.admin_url('themes.php?page=wpo_livethemeedit').'">'.__('Create Profile Now', TEXTDOMAIN).'</a></div>';
            printf( 
    ...
    class WPO_Layout_DropDown extends WP_Customize_Control{
        ...
        public function render_content(){
            ...
            $layouts = array(
                '0-1-0' => __('Fullwidth', TEXTDOMAIN),
                '1-1-0' => __('Left - Main Sidebar', TEXTDOMAIN),
                '0-1-1' => __('Main - Right Sidebar', TEXTDOMAIN),
                '1-1-1' => __('Left - Main - Right Sidebar', TEXTDOMAIN),
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class WPOpalTextAreaControl extends WP_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array() ) {
            $this->statuses = array( '' => __( 'Default', TEXTDOMAIN ) );
