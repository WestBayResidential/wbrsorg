...
class WPO_Frontend extends WPO_Framework {
	...
	private function initRequirePlugin(){
		...
		$this->addRequiredPlugin(array(
		    ...
		    'source'                	 =>  get_template_directory(). '/plugins/appthemer-crowdfunding.zip',// If false, the plugin is only 'recommended' instead of required
		    'required' 					=>true
		));
