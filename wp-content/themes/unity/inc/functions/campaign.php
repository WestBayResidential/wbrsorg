		...
		<ul>
			...
			<li class="price-custom">
				<div class="campaign-price-input">
					<div class="price-wrapper"><span class="title"><?php _e('Amount: ', TEXTDOMAIN); ?></span><input type="text" name="atcf_custom_price" value="" /></div>
				</div>	
			</li>
...
function wpo_field_submit(){
	...
	return array(
		'campaign_heading' => array(
			'label'       => __( 'Campaign Information', TEXTDOMAIN ),
			'type'        => 'heading',
			'default'     => null,
			'editable'    => true,
			'priority'    => 2
		...
		'goal' => array(
			'label'       => sprintf( __( 'Goal (%s)', TEXTDOMAIN ), edd_currency_filter( '' ) ),
			'default'     => null,
			'type'        => 'text',
			'editable'    => false,
		...
		'type' => array(
			'label'       => __( 'Funding Type', TEXTDOMAIN ),
		...
		'video' => array(
			'label'       => __( 'Featured Video URL', TEXTDOMAIN ),
			'default'     => null,
			'type'        => 'text',
			'editable'    => true,
			'placeholder' => null,
		...
		'backer_rewards_heading' => array(
			'label'       => __( 'Backer Rewards', TEXTDOMAIN ),
			'type'        => 'heading',
			'default'     => null,
			'editable'    => true,
			'priority'    => 26
		...
		'physical' => array(
			'label'       => __( 'Collect shipping information on checkout.', TEXTDOMAIN ),
			'default'     => null,
			'type'        => 'checkbox',
			'editable'    => true,
			'placeholder' => null,
		...
		'norewards' => array(
			'label'       => __( 'No rewards, donations only.', TEXTDOMAIN ),
			'default'     => null,
			'type'        => 'checkbox',
			'editable'    => false,
			'placeholder' => null,
		...
		'info_heading' => array(
			'label'       => __( 'Your Information', TEXTDOMAIN ),
			'type'        => 'heading',
			'default'     => null,
			'editable'    => true,
			'priority'    => 34
		...
		'organization' => array(
			'label'       => __( 'Name/Organization', TEXTDOMAIN ),
			'default'     => null,
			'type'        => 'text',
			'editable'    => true,
			'placeholder' => null,
