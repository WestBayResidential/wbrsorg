...
<div id="wpo-templates">
    ...
    <p class="wpo_section">
        ...
        <select  name="<?php $mb->the_name(); ?>">
            <option value="default" <?php $mb->the_select_state('default'); ?>><?php echo __('Blog Default',TEXTDOMAIN); ?></option>
            <option value="masonry" <?php $mb->the_select_state('masonry'); ?>><?php echo __('Blog Masonry',TEXTDOMAIN); ?></option>
            <option value="list" <?php $mb->the_select_state('list'); ?>><?php echo __('Blog List',TEXTDOMAIN); ?></option>
        </select>
    </p>
