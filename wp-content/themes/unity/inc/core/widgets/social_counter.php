...
class bk_social_counter extends WP_Widget {
			...
			<ul>
				...
				<?php if (isset($bk_twitter_id)&&($bk_twitter_id != NULL)){ ?>
					<li class="twitter clear-fix">
                        <a target="_blank" href="http://twitter.com/<?php echo esc_attr( $bk_twitter_id ); ?>">
    						...
    						<div class="left">
    							<div class="count"><h4><?php echo esc_html( get_option('bk_twitter_followers') ); ?></h4></div>
    							<div class="text"><?php _e('Followers', TEXTDOMAIN);?></div>
    						</div>
                        </a>
					</li> <!-- /twitter -->
				<?php } ?>
				...
				<?php if (isset($bk_facebook_username) && ($bk_facebook_username != NULL)){ ?>
					<li class="facebook clear-fix">
                        <a target="_blank" href="<?php echo esc_url( get_option('bk_facebook_link') ); ?>">
    						<div class="icon"><i class="fa fa-facebook"></i></div>
    						<div class="left">				
    							<div class="count"><h4><?php echo esc_html( get_option('bk_facebook_followers') ); ?></h4></div>
    							<div class="text"><?php _e('Likes', TEXTDOMAIN);?></div>				
    						</div>
                        </a>
					</li><!-- /facebook -->
				<?php } ?>
				...
				<?php if (isset($bk_dribbble_username)&&($bk_dribbble_username != NULL)){ ?>
					<li class="dribbble clear-fix">
                        <a target="_blank" href="http://dribbble.com/<?php echo esc_attr( $bk_dribbble_username ); ?>">
    						...
    						<div class="left">
    							<div class="count"><h4><?php echo esc_html( get_option('bk_dribbble_followers') ); ?></h4></div>
    							<div class="text"><?php _e('Followers', TEXTDOMAIN); ?></div>		
    						</div>
                        </a>				
					</li>
				...
				<?php if (isset($bk_youtube_username)&&($bk_youtube_username != NULL)){ ?>
					<li class="youtube clear-fix">
                        <a target="_blank" href="http://www.youtube.com/user/<?php echo esc_attr( $bk_youtube_username ) ;?>">
    						...
    						<div class="left">
    							<div class="subscribe"><h4><?php echo esc_html( get_option('bk_youtube_subscribers') ); ?></h4></div>
    							<div class="text"><?php _e('Subscribe', TEXTDOMAIN); ?></div>		
    						</div>
                        </a>				
					</li>
				<?php } ?>
                ...
                <?php if (isset($bk_rss_url)){ ?>
					<li class="rss clear-fix">
                        <a target="_blank" href="<?php echo esc_url( $bk_rss_url ); ?>">
    						...
    						<div class="left">
    							<div class="subscribe"><h4><?php _e('Subscribe', TEXTDOMAIN); ?></h4></div>
    							<div class="text"><?php _e('RSS Feeds', TEXTDOMAIN); ?></div>		
    						</div>	
                        </a>			
					</li>
				<?php } ?>
	...
	function form( $instance ) {
		...
		<!-- Title: Text Input -->     
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><strong><?php _e('Title:', TEXTDOMAIN);?></strong></label>
            <input type="text" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>" class="widefat" />
		</p>
                
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bk_facebook_username' ) ); ?>"><strong><?php _e('Facebook Username:', TEXTDOMAIN);?></strong></label>
        ...
        <p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bk_dribbble_username' ) ); ?>"><strong><?php _e('Dribbble Username', TEXTDOMAIN);?></strong></label>
        ...
        <p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bk_youtube_username' ) ); ?>"><strong><?php _e('Youtube username', TEXTDOMAIN);?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bk_rss_url' ) ); ?>"><strong><?php _e('RSS URL', TEXTDOMAIN);?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bk_twitter_id' ) ); ?>"><strong><?php _e('Twitter Name', TEXTDOMAIN);?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bk_consumer_key' ) ); ?>"><strong><?php _e('Consumer key', TEXTDOMAIN) ?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bk_consumer_secret' ) ); ?>"><strong><?php _e('Consumer secret', TEXTDOMAIN) ?></strong></label>
