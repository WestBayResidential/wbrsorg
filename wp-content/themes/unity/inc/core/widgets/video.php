...
class WPO_Featured_Video_Widget extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Featured Video Widget', TEXTDOMAIN),
             // Widget description
            array( 'description' => __( 'Show Featured video', TEXTDOMAIN ),)
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php echo __('Title:', TEXTDOMAIN ); ?></label>
            <br>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
        </p>

        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'video_link' ) ); ?>"><?php echo __('Video link:', TEXTDOMAIN ); ?></label>
            <br>
            ...
            <br>
            <?php echo __('Support video from Youtube and Vimeo link. Ex: https://www.youtube.com/watch?v=Drei_jt2kos', TEXTDOMAIN ); ?>
        </p>

        <p>
            <label for="<?php echo  esc_attr( $this->get_field_id('video_name') ); ?>"><?php echo __('Video name:', TEXTDOMAIN ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_width') ); ?>"><?php echo __('Video width:', TEXTDOMAIN); ?></label>
            <br>
