...
class WPO_Socials_Siderbar_Widget extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Socials Siderbar', TEXTDOMAIN),
            // Widget description
            array( 'description' => __( 'Share Socials Siderbar for website.', TEXTDOMAIN ), )
        );
...
// Widget Backend
    ...
    <div class="wpo_socials_siderbar">
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('position') ); ?>"><?php echo __('Position Share: ', TEXTDOMAIN); ?></label>
            </br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'list_service' ) ); ?>"><?php echo __( 'Share services social:', TEXTDOMAIN ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('skin') ); ?>"><?php echo __('Theme:', TEXTDOMAIN); ?></label>
            </br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('show_mobile') ); ?>"><?php echo __('Show moblie:', TEXTDOMAIN); ?></label>
            </br>
