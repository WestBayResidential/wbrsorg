		...
		<div class="wpo-customize" id="wpo-customize">
			<div class="wrapper">
				<div id="customize-form">
					...
					<p>
						<span class="badge">
							<?php echo __('Theme', TEXTDOMAIN);?>: <?php echo TEXTDOMAIN; ?>
						</span>
						<?php 
							$url_customize = admin_url( 'customize.php?theme='.TEXTDOMAIN );
							$url_back = admin_url();
							 
						?>
						<a  href="<?php echo esc_url( $url_customize );?>" class="label label-default pull-right">
							<?php echo __('Customize', TEXTDOMAIN);?>
						</a>
						<a  href="<?php echo esc_url( $url_back );?>" class="label label-default pull-right">
							<?php echo __('Back', TEXTDOMAIN);?>
						</a>
					</p>
					<!-- END THEMENAME -->
					...
					<div class="groups clearfix">
						<div class="form-group pull-left">
							<label><?php echo __('Css Profiles:', TEXTDOMAIN); ?></label>
						...
						<div class="form-group ">
							<label class="show-for-notexisted"><?php echo __('And Named This: ', TEXTDOMAIN); ?></label>
							<label class="show-for-existed"><?php echo __('And Rename To:', TEXTDOMAIN); ?></label>
												...
												<div class="accordion-inner panel-body clearfix">
													...
													<?php  if (isset($item['type'])&&$item['type']=="image") { ?>
														<div class="form-group background-images">
															...
															<p>
																<em style="font-size:10px"><?php echo __('Those Images in folder YOURTHEME/images/bg/', TEXTDOMAIN) ?></em>
															</p>
