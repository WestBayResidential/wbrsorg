...
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1><?php echo __( 'Vertical Megamenu Editor', TEXTDOMAIN );?></h1>
			</div>
			<div class="col-md-12">
				<div class="form-group">
					<label class="control-label pull-left"><?php echo __('Menu Group', TEXTDOMAIN); ?></label>
...
<div class="megamenu-pages container">
	...
	<ul class="nav nav-tabs">
	  <li class="active"><a href="#megamenu-editor" data-toggle="tab" ><?php echo __('MegaMenu', TEXTDOMAIN); ?></a></li>
	  <li><a href="#manage-widget" data-toggle="tab"><?php echo __('Manage Widgets', TEXTDOMAIN); ?></a></li>
	</ul>
 ...
 <!-- Modal -->
  <div class="modal fade" id="myModal" tabindex="-1" data-backdrop="false" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo __('Widget Management', TEXTDOMAIN); ?></h4>
        </div>
	...
	<div  id="widget-form" style="display: none; left: 340px;  min-width:400px" class="popover bottom   form-setting">
		<div class="arrow"></div>
		<h3 style="display: block;" class="popover-title"><?php echo __('Widget Setting', TEXTDOMAIN);?><span class="badge pull-right"><?php echo __('Close', TEXTDOMAIN);?></span></h3>
		<div class="popover-content">
			...
			<button type="button" id="btn-inject-widget" class="btn btn-primary btn-sm"><?php echo __('Insert', TEXTDOMAIN);?></button>
			<a href="<?php echo esc_url( $action_addwidget ); ?>" id="btn-add-widget" rel="refresh-page" class="btn btn-sm btn-modal btn-success btn-action"><?php echo __('Add Widget', TEXTDOMAIN);?></a>
		</div>
	</div>
		...
		<div id="menu-toolbars">
				<div>
					<div class="pull-right">
						<a href="<?php echo esc_url( $action_addwidget ); ?>" id="btn-add-widget" rel="refresh-page" class="btn btn-modal btn-success btn-action"><?php echo __('Add Widget', TEXTDOMAIN);?></a>
						<a href="<?php echo esc_url( $live_site_url );?>" class="btn btn-modal btn-primary btn-sm btn-action hidden-md hidden-lg" ><?php echo __('Preview', TEXTDOMAIN);?></a> |
						<a id="unset-data-menu" href="#" class="btn btn-danger btn-action"><?php echo __('Reset Megamenu', TEXTDOMAIN);?></a>
						<button id="save-data-menu" class="btn btn-warning"><?php echo __('Save', TEXTDOMAIN)?></button>
					</div>
					<a id="save-data-back" class="btn btn-default" href="<?php echo esc_url( $action_backlink );?>"><?php echo __('Back', TEXTDOMAIN);?></a>
				</div>
			</div>
	</div>
	...
	<div class="tab-content">
		<div class="tab-pane" id="manage-widget">
			<table class="form table table-striped">
			 	<tr>
			 		<th><?php echo __('Wiget Name', TEXTDOMAIN); ?></th>
			 	...
			 	<?php foreach( $widgets  as $widget ) { ?>
			     	<tr data-widget-id="<?php echo esc_attr( $widget->id ); ?>">
			    	 	...
			    	 	<td>
			    	 		<a class="wpo-edit-widget" rel="edit" data-type="<?php echo esc_attr( $widget->type ); ?>" data-id='<?php echo esc_attr( $widget->id ); ?>' href="#" ><?php echo __('Edit', TEXTDOMAIN); ?></a>
			    	 		|
			    	 		<a rel="delete" class="wpo-delete" data-message="<?php echo __('Are You Sure ?', TEXTDOMAIN); ?>" data-id='<?php echo esc_attr( $widget->id ); ?>' href="#"><?php echo __('Delete', TEXTDOMAIN); ?></a>
			    	 	</td>
			     	<?php } ?>
			     	</tr>
			 	<?php } ?>
	  	...
	  	<div class="tab-pane active" id="megamenu-editor">
				<div id="menu-form"  style="display: none; left: 340px; top: 15px; max-width:600px" class="popover top out form-setting">
							<div class="arrow"></div>
							<h3 style="display: block;" class="popover-title">Sub Menu Setting <span class="badge pull-right"><?php echo __('Close', TEXTDOMAIN);?></span></h3>
							<div class="popover-content">
								...
								<table class="table table-hover">
									...
									<tr>
										<td><?php echo __('Create Sub Menu', TEXTDOMAIN);?></td>
										<td>
											<select name="menu_submenu" class="menu_submenu">
												<option value="0"><?php echo __('No', TEXTDOMAIN);?></option>
												<option value="1"><?php echo __('Yes', TEXTDOMAIN);?></option>
											</select>
										</td>
									</tr>

									<tr>
										<td><?php echo __('Width Submenu', TEXTDOMAIN);?></td>
										<td>
											 <input type="text" name="menu_subwidth" class="menu_subwidth">
										</td>
									</tr>
									<tr>
										<td><?php echo __('Text Customize', TEXTDOMAIN);?></td>
										<td>
											 <input type="text" name="text_customize" class="text_customize">
										</td>
									</tr>
									<tr>
										<td><?php echo __('Icon', TEXTDOMAIN);?></td>
										<td>
											 <input type="text" name="menu_icon" class="menu_icon">
										</td>
									</tr>
									<tr>
										<td><?php echo __('Description', TEXTDOMAIN);?></td>
										<td>
											<textarea name="menu_description" class="menu_description" cols="30" rows="2"></textarea>
										</td>
									</tr>
									<tr class="table-alignments">
										<td><?php echo __( 'Alignment', TEXTDOMAIN ); ?></td>
										<td>
									...
									<tr>
										<td colspan="2">
											<button type="button" class="add-row btn btn-success btn-sm"><?php echo __('Add Row', TEXTDOMAIN);?></button>
											<button type="button" class="remove-row btn btn-default  btn-sm"><?php echo __('Remove Row', TEXTDOMAIN);?></button>
											| <button type="button" class="add-col btn btn-success  btn-sm"><?php echo __('Add Column', TEXTDOMAIN);?></button>
										</td>
									</tr>
								</table>
						...
						<div id="column-form" style="display: none; left: 340px; top: 45px;" class="popover top   form-setting">
							<div class="arrow"></div>
							<h3 style="display: block;" class="popover-title"><?php echo __('Column Setting', TEXTDOMAIN)?> <span class="badge pull-right"><?php echo __('Close', TEXTDOMAIN);?></span></h3>
							<div class="popover-content">
								<form    method="post" action="<?php echo esc_url( $liveedit_action );?>"  enctype="multipart/form-data" >
								<table class="table table-hover">
									<tr>
										<td><?php echo __('Addition Class', TEXTDOMAIN);?></td>
										<td>
									...
									<tr>
										<td colspan="2"><button type="button" class="remove-col btn btn-default  btn-sm"><?php echo __('Remove Column', TEXTDOMAIN);?></button> </td>
									</tr>
								</table>
								</form>
							</div>
						...
						<div  id="submenu-form" style="display: none; left: 340px; top: 45px;" class="popover top  form-setting">
							<div class="arrow"></div>
							<h3 style="display: block;" class="popover-title"><?php echo __('Setting Sub Menu', TEXTDOMAIN);?><span class="badge pull-right"><?php echo __('Close', TEXTDOMAIN);?></span></h3>
							<div class="popover-content">
								<form   method="post" action="<?php echo esc_url( $liveedit_action );?>"  enctype="multipart/form-data" >
									...
									<table class="table table-hover">
										<tr>
											<td><?php echo __('Group Submenu', TEXTDOMAIN);?></td>
											<td>
...
<script type="text/javascript">
	...
	$("#menugroup").change( function(){	 
		if( $("#menugroup").val() ){ 
			location.href="<?php echo esc_js( admin_url('themes.php?page=wpo_megamenu_vertical') ); ?>&group="+$("#menugroup").val();
		}
	} );
