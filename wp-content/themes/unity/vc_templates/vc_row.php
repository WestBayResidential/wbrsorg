...
$output='<section class="wpb-container' . esc_attr( $el_class ) . vc_shortcode_custom_css_class( $css, ' ' ).'" '.$parallax.'>' . $icon . '<div class="wpb-inner'.($isfullwidth == '1'?' container':' ').'" '.$style.'>';
