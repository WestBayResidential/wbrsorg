...
$output .= "\n\t\t\t".'<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count='. esc_js( $count ) . '&amp;display='. esc_js( $display ) .'&amp;size=s&amp;layout=x&amp;source='. esc_js( $type ) .'&amp;'. esc_js( $type ) .'='. esc_js( $flickr_id ) .'"></script>';
