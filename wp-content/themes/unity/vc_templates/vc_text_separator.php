...
<div class="widget widget-text-separator <?php echo esc_attr(trim($css_class)); ?>">
	<span class="vc_sep_holder vc_sep_holder_l"><span<?php echo trim( $inline_css ); ?> class="vc_sep_line"></span></span>
	<?php if($title!=''): ?>
    ...
    <?php endif; ?>
	<span class="vc_sep_holder vc_sep_holder_r"><span<?php echo trim( $inline_css ); ?> class="vc_sep_line"></span></span>
</div>
<?php echo trim( $this->endBlockComment('separator') )."\n";