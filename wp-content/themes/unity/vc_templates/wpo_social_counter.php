...
<div class="widget wpo-social-counter <?php echo esc_attr( $class ); ?>">
    ...
    <div class="widget-content">
	    ...
	    <?php if( $show_facebook && !empty( $facebook_id) ): ?>
	        <li class="diverz facebook">
			    ...
			    <div class="sub-diverz">
			        <span class="count"><?php echo wpo_facebook_count( $facebook_id ) ?></span>
			        <span class="count-name"><?php echo __('Like', TEXTDOMAIN); ?></span>
			    </div>
	        </li>
        <?php endif; ?>
        <?php if( $twitter_show && !empty( $twitter_user)): ?>         
	        <li class="diverz twitter">
		        ...
		        <div class="sub-diverz">
		        	...
		        	<span class="count-name"><?php echo __('Followers', TEXTDOMAIN); ?></span>
		        </div>
	        </li>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if( $show_youtube && !empty( $youtube_usename)): ?>

	        <li class="diverz youtube">
		        <a href="https://www.youtube.com/user/<?php echo esc_attr( $youtube_usename ); ?>">
			        <div class="main-diverz">
				        <i class="youtube fa fa-youtube"></i>
			        </div>
		        </a>
		        <div class="sub-diverz">
		        	<span class="count"><?php echo wpo_youtube_count( $youtube_usename ) ?></span>
		        	<span class="count-name"><?php echo __('Subscriptions', TEXTDOMAIN); ?></span>
		        </div>
	        </li>
        <?php endif; ?>
	    </ul>
