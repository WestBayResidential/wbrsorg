	...
	<div class="tab-content">
		...
		?>
			<div role="tabpanel" class="tab-pane <?php echo ($query->current_post==0 ? 'active' : ''); ?>" id="campaign-<?php echo esc_attr( $_id ); ?>-<?php echo esc_attr( $query->current_post ); ?>">
				...
				<div class="campaign-time-left text-center"><span class="title"><?php _e('Expired on: ', TEXTDOMAIN) ?></span><span><?php echo trim( $campaign->days_remaining() ); ?><?php _e(' Day', TEXTDOMAIN); ?></span></div>
				<div class="clearfix"></div>
