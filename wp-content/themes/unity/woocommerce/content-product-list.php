                ...
                <div class="product-assets">
        			...
        			<div class="button-groups">
                        ...
                        <div class="yith-compare hidden-xs hidden-sm">
                            <a href="<?php echo esc_url( wp_nonce_url( add_query_arg( $url_args ), $action_add ) ); ?>" class="compare" data-product_id="<?php echo $product->id; ?>"> <i class="fa fa-files-o"></i> <span><?php echo __('add to compare',TEXTDOMAIN); ?></span> </a>
                        </div>
                        <?php } ?>
        	        </div>
                </div>
