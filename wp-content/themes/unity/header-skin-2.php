...
<body <?php body_class(); ?>>
    ...
    <section class="wpo-wrapper <?php echo isset($meta_template['el_class']) ? $meta_template['el_class'] : '' ; ?>">
        ...
        <!-- // Topbar -->
        <!-- HEADER -->
        <header id="wpo-header" class="wpo-header wpo-header-absolute">
       
            <div class="container-inner header-wrap skin-absolute">
                    ...
                    <div class="logo-in-theme pull-left">
                        ...
                        <?php } else { ?>
                            <div class="logo logo-theme">
                                <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                                     <img src="<?php echo get_template_directory_uri() . '/images/logo-2.png'; ?>" alt="<?php bloginfo( 'name' ); ?>" />
                                </a>
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="container">
                        <div class="mainmenu-content-wapper">
                            <div class="mainmenu-content">
                              ...
                              <?php if (WPO_CROWDFUNDING_ACTIVED && wpo_theme_options('enable_button_campaign', true)) : ?>    
                            <div class="btn-create-campaign hidden-xs hidden-sm">
                            <?php $link_create = (wpo_theme_options('enable_link_campaign', false)) ? ( wpo_theme_options('link_button_campaign', '#')): wpo_crowdfunding_get_page_url('submit_page'); ?>
                                <a class="user-campaign button" href="<?php echo esc_url( $link_create); ?>"><i class="fa fa-plus"></i><span class="hidden-sm hidden-md"><?php echo wpo_theme_options('text_button_campaign', __('Creat a campaign', TEXTDOMAIN) ); ?></span></a>
                            </div>
                        <?php endif; ?>  
                        </div>    
                    </div>
