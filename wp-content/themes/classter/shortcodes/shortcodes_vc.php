...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "curve",
			"heading" => __("No Rounded corners", "themerex"),
			"description" => __("No Rounded corners", "themerex"),
			"class" => "",
			"value" => array(__('No Rounded corners', 'themerex') => 'no'),
			"type" => "checkbox",
		),
		array(
			"param_name" => "style",
			...
			"value" => array(
				...
				__('Border (color 2 hover)', 'themerex') => 'border_1'
			),
			"type" => "dropdown"
        ),
		array(
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "style",
			"heading" => __("Style", "themerex"),
			"description" => __("Select the table style", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array(
				__('Light', 'themerex') => 'light',
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "active",
			"heading" => __("Active", "themerex"),
			"description" => __("Active column", "themerex"),
			"class" => "",
			"value" => array(__('Active column', 'themerex') => 'yes'),
			"type" => "checkbox"
		),
		$THEMEREX_VC_id,
		$THEMEREX_VC_class
