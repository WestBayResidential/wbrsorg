...
$THEMEREX_options[] = array( "title" => __('Background image for styling themes',  'themerex'),
	"desc" => __('Upload background image for styling themes.',  'themerex'),
	"id" => "bg_custom_image_style",
	"override" => "category,post,page",
	"std" => "",
	"type" => "media");
...
$THEMEREX_options[] = array( "title" => __('Main menu style', 'themerex'),
			...
			"divider" => false,
			"std" => "line",
			"options" => array("line"=>__("Shaded White", 'themerex'), "line_gray"=>__("Shaded Gray", 'themerex'), "fon"=>__("Transparent", 'themerex')),
			"dir" => "horizontal",
			"type" => "radio");
...
$THEMEREX_options[] = array( "title" => __('Background image for styling themes',  'themerex'),
	"desc" => __('Upload background image for styling themes (header area). If is not set, using the preinstalled. (If set to "Global style" and the menu style "Transparent")',  'themerex'),
	"id" => "bg_custom_image_style_header",
	"override" => "category,post,page",
	"std" => "",
	"type" => "media");

$THEMEREX_options[] = array( "title" => __("Show user's header below the menu", 'themerex'),
	"desc" => __("Show user's header below the menu. If set to \"Global style\" and the menu style \"Transparent\"", 'themerex'),
	"id" => "show_top_page_below",
	"override" => "category,post,page",
	"std" => "no",
	"options" => $yes_no,
	"type" => "switch");
...
$THEMEREX_options[] = array( "title" => __('Contacts in header (E-mail)', 'themerex'),
